...
export default function DynamicPage({ params }: PageProps) {
  ...
  // Общий стиль для всех страниц книги: flex-колонка, footer внизу
  ...
  if (slug === 'book') {
    const pages: React.ReactNode[] = [
      ...
      <div className="lv-page" key="page-5" style={pageBaseStyle}>
        <div>
          <div className="lv-page-header">
            <div className="lv-page-subtitle">
              Философский текст · Часть I
            </div>
          ...
          >
            <p>
              Здесь будет первая часть большого философского ответа — общий
              образ человека, который проявляется через его ответы. Эта
              страница расскажет, как вы обычно смотрите на мир, к чему
              тяготеете и что для вас кажется естественным способом жить.
            </p>
            <p>
              Позже сюда подставится реальный текст, созданный по вашим
              ответам. Он займет целую страницу и будет написан так, как
              будто вы держите в руках личное предисловие к собственной
              жизни.
            </p>
          </div>
        </div>
      ...
      <div className="lv-page" key="page-6" style={pageBaseStyle}>
        <div>
          <div className="lv-page-header">
            <div className="lv-page-subtitle">
              Философский текст · Часть II
            </div>
          ...
          >
            <p>
              На этой странице будет говорить о том, что для вас
              по-настоящему важно: люди, свобода, безопасность, творчество,
              путь, в котором есть смысл. Текст будет собран из оттенков
              ваших ответов, а не только из прямых слов.
            </p>
            <p>
              Здесь мы не будем ставить диагнозы и давать ярлыки — это
              именно философский взгляд: спокойное, внимательное описание
              того, что уже есть в вашей жизни и на что вы можете
              опираться.
            </p>
          </div>
        </div>
      ...
      <div className="lv-page" key="page-7" style={pageBaseStyle}>
        <div>
          <div className="lv-page-header">
            <div className="lv-page-subtitle">
              Философский текст · Часть III
            </div>
          ...
          >
            <p>
              Здесь появится мягкий разбор тех мест, где вы сами с собой не
              до конца согласны: чего хотите и чего боитесь одновременно,
              где вам тесно в старых решениях, но страшно делать новые.
            </p>
            <p>
      ...
      <div className="lv-page" key="page-8" style={pageBaseStyle}>
        <div>
          <div className="lv-page-header">
            <div className="lv-page-subtitle">
              Философский текст · Часть IV
            </div>
          ...
          >
            ...
            <p>
              ...
              темы уже звучат в вашей жизни и какие развилки перед вами
              стоят.
            </p>
          </div>
        </div>
      ...
      <div className="lv-page" key="page-9" style={pageBaseStyle}>
        <div>
          <div className="lv-page-header">
            <div className="lv-page-subtitle">
              Философский текст · Часть V
            </div>
          ...
          >
            <p>
              На этой странице будут несколько аккуратных предложений: как
              можно жить чуть честнее с собой, учитывая всё, что вы
            ...
            <p>
              ...
              направления, которые можно взять с собой после закрытия
              книги, чтобы она не осталась просто красивым объектом, а
              стала началом следующего куска пути.
            </p>
          </div>
        </div>
